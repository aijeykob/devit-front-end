...
import { getPosts, createPost, getPost, updatePost, removePost } from './functionsForSagas';
...
export default function* rootSaga() {
  yield all([watchGetPosts(), watchCreatePost(), watchGetPost(), watchUpdatePost(), watchRemovePost()]);
}
